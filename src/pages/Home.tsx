  ...
  return (
    <div className="light-page">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden" style={{ background: '#030c1e' }}>
        ...
        <div className={`absolute right-0 top-0 bottom-0 w-full md:w-[48%] lg:w-[50%] z-[2] hidden md:flex items-center justify-center pointer-events-none transition-all duration-1200 ${loaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
        ...
        <div className={`relative z-10 max-w-7xl lg:max-w-[1440px] xl:max-w-[1600px] mx-auto px-6 lg:px-12 xl:px-16 w-full pt-28 pb-20 transition-all duration-1000 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="max-w-3xl mx-auto md:mx-0 text-center md:text-left md:max-w-[52%] lg:max-w-[48%] xl:max-w-[45%]">
            ...
            <p className="text-ice-100/70 text-lg leading-relaxed mb-7 max-w-lg mx-auto md:mx-0"
              dangerouslySetInnerHTML={{ __html: hero.subheadline }} />

            <div className="flex gap-7 mb-7 justify-center md:justify-start">
